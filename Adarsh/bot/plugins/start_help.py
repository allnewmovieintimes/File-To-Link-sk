...
async def start(b, m):
    ...
    if usr_cmd == "/start":
        ...
        await m.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("⚡ 𝚄𝙿𝙳𝙰𝚃𝙴𝚉 ⚡", url="https://t.me/skmoviesupdate"), InlineKeyboardButton("⚡ 𝚂𝚄𝙿𝙿𝙾𝚁𝚃 ⚡", url="https://t.me/skmoviesupdate")],
                    [InlineKeyboardButton("𝙳𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚛⚜️", url="https://t.me/skmoviesupdate"), InlineKeyboardButton("💠 𝙾𝚝𝚑𝚎𝚛 𝙱𝚘𝚝𝚣 💠", url="https://t.me/skmoviesupdate")],
...
async def about_handler(bot, message):
    if not await db.is_user_exist(message.from_user.id):
        ...
        await bot.send_message(
            Var.BIN_CHANNEL,
            f"#NEW_USER: \n\nNew User [{message.from_user.first_name}](tg://user?id={message.from_user.id}) Started the bot File store bot!!"
        )
    if Var.UPDATES_CHANNEL is not None:
        try:
            user = await bot.get_chat_member(Var.UPDATES_CHANNEL, message.chat.id)
...
┃
┣⪼<b>𝙱𝙾𝚃-𝙽𝙰𝙼𝙴 : <a href='https://t.me/skmoviesupdate'>𝐒𝐊 𝐅𝐢𝐥𝐞 𝐭𝐨 𝐋𝐢𝐧𝐤 𝐁𝐨𝐭</a></b>
┣⪼<b>𝚄𝙿𝙳𝙰𝚃𝙴𝚉 : <a href='https://t.me/skmoviesupdate'>𝐒𝐊 𝐅𝐢𝐥𝐞 𝐭𝐨 𝐋𝐢𝐧𝐤 𝐁𝐨𝐭</a></b>
┣⪼<b>𝚂𝚄𝙿𝙿𝙾𝚁𝚃 : <a href='https://t.me/skmoviesupdate'>𝐒𝐊 𝐅𝐢𝐥𝐞 𝐭𝐨 𝐋𝐢𝐧𝐤 𝐁𝐨𝐭</a></b>
┣⪼<b>𝚂𝙴𝚁𝚅𝙴𝚁 : 𝙷𝙴𝚁𝚄𝙺𝙾</b>
┣⪼<b>𝙻𝙸𝙱𝚁𝙰𝚁𝚈 : 𝙿𝚁𝙾𝙶𝚁𝙰𝙼</b>
┣⪼<b>𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 3</b>
┣⪼<b>𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 : <a href='https://t.me/skmoviesupdateowner'>𝐒𝐊 𝐅𝐢𝐥𝐞 𝐭𝐨 𝐋𝐢𝐧𝐤 𝐁𝐨𝐭</a></b>
┣⪼<b>𝙾𝚃𝙷𝙴𝚁 𝙱𝙾𝚃𝚉 : <a href='https://t.me/skmoviesupdate'>𝙾𝚝𝚑𝚎𝚛 𝙱𝚘𝚝𝚜 𝙱𝚢 𝙱𝚎𝚝𝚊 𝙱𝚘𝚝𝚣</a></b>
┃
<b>╰━━━━━━━〔𝙿𝙻𝙴𝙰𝚂𝙴 𝚂𝚄𝙿𝙿𝙾𝚁𝚃〕</b>""",
  parse_mode="html",
        disable_web_page_preview=True,
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("⚡ 𝚄𝙿𝙳𝙰𝚃𝙴𝚉 ⚡", url="https://t.me/beta_bot_updates"), InlineKeyboardButton("𝚂𝚞𝚙𝚙𝚘𝚛𝚝", url="https://t.me/skmoviesupdate")],
                [InlineKeyboardButton("💌 𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 💌", url="https://t.me/JP_Jeol_org")]
            ]
        )
    )
